...
# test_path = "./Energy/_final/train_test/42_test_with_sunshine_solar.csv"
test_path = "./Energy/01/06_test_55_knn.csv"
...
mae =r2_score(train['일조(hr)'], test['일조(hr)'])
mae2 = r2_score(train['일사(MJ/m2)'], test['일사(MJ/m2)'])

print(f"{test_path}")
print(f"일조 R2 : {mae:.6f} | 일사 R2 : {mae2:.6f}")


# ./Energy/01/06_test_43_.csv
# 일조 R2 : 0.803281 | 일사 R2 : 0.785940

# ./Energy/02/submission/test_interpolated_top30_features_SEED43.csv
# 일조 R2 : 0.764683 | 일사 R2 : 0.694617

# ./Energy/02/submission/test_interpolated_optuna_ensemble_SEED43.csv
# 일조 R2 : 0.766553 | 일사 R2 : 0.694790

# ./Energy/02/06_test_43_.csv
# 일조 R2 : 0.803371 | 일사 R2 : 0.782135