...
# 예측에 사용할 피처 선택
insolation_features = ['peak_time', '이슬점온도', '이슬점차이', '체감온도','일조(hr)', 'SIN_시', 'COS_시', '정오거리', 
                       '시각', '요일', '월', 'SIN_일', 'COS_일', 'SIN_요일', 'COS_요일',
                       'rainy', 'high_humidity', 'cloudy_or_rain', 'humid_x_rain', 'discomfort_index', 
                       'THI', 'CDH', 'cloudy_based_on_humidity', 'sunrise_hour', 'sunset_hour', 'daylight', 
...
sunshine_features = ['peak_time', '이슬점온도', '이슬점차이', '체감온도', 'SIN_시', 'COS_시', '정오거리', 
                     '시각', '요일', '월', 'SIN_일', 'COS_일', 'SIN_요일', 'COS_요일',
                     'rainy', 'high_humidity', 'cloudy_or_rain', 'humid_x_rain', 'discomfort_index', 
                     'THI', 'CDH', 'cloudy_based_on_humidity', 'sunrise_hour', 'sunset_hour', 'daylight', 
                     'solar_elevation', 'solar_rel_pos', 'extraterrestrial_rad']
