...
log_path = './Study25/_data/dacon/전력사용/log/'
os.makedirs(log_path, exist_ok=True)
version = 'ver2'
seed_file = f"./Study25/_data/dacon/03 전력사용/log/({version})SEED_COUNTS.json"
...
path = './Study25/_data/dacon/전력사용/'
path_sub = './Study25/_data/dacon/전력사용/sub/'
py_path = './Energy/03/'
...
train_path = './Study25/_data/dacon/03 전력사용/train.csv'
test_path = './Study25/_data/dacon/03 전력사용/test.csv'
building_path = './Study25/_data/dacon/03 전력사용/building_info.csv'
sub_path = './Study25/_data/dacon/03 전력사용/sample_submission.csv'
...
def _optimize_quiet(objective, n_trials, desc, seed, enqueue_params=None, print_best=False):
    ...
    study.optimize(objective, n_trials=n_trials)  # 진행바/콜백 없음
    if print_best:
...
def _train_one_model_cv_optuna(
    ...
    n_trials_weight=12,         # ← 가중치 튜닝 횟수(진행바 X)
...
def _fit_ensemble_weights_smape(oof_df, y, base_weights=None, trials=40, seed=73, l2=0.0):
    """
...
import datetime
save_path = f'./Study25/_data/dacon/전력사용/sub/{SEED}_submission_{version}/'
