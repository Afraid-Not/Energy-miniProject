...
import datetime
save_path = f'./Energy/03/{SEED}_submission_ver2_5_1/'
...
intervals = {
    ...
    12: [(2024072108, 2024072111), (2024082408, 2024082410)],
    17: [(2024062415, 2024062609)],
    ...
    89: [(2024071208, 2024071222)],
    90: [(2024060517, 2024060518)],
    91: [(2024071714, 2024071723)],
