...
# 전체 데이터로 모델 학습
xgb_model_full = XGBRegressor(n_estimators=1000, learning_rate=0.05, n_jobs=-1, random_state=SEED)
lgbm_model_full = LGBMRegressor(n_estimators=1000, learning_rate=0.05, n_jobs=-1, random_state=SEED, verbosity=-1)
