...
seed_file = "./Energy/best_model/(SEED_COUNT)13_01_preprocessing.json"
...
new_path = f'./Energy/best_model/{SEED}_submission'
...
with open(new_path + "(LOG)13_01_preprocessing.txt", "a") as f:
    f.write(f"<SEED : {SEED}>\n")
