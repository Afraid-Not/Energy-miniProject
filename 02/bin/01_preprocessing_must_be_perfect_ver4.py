...
insolation_features = [
    ...
    '가시거리_고급',
    '대기투명도',
    'expected_sunshine_ratio',
    'cloud_cover_wind_adjusted'
]
...
# 결과 저장
train_all.to_csv(trainer + f'06_train_{SEED}_ver4.csv', index=False)
test_all.to_csv(trainer + f'06_test_{SEED}_ver4.csv', index=False)
