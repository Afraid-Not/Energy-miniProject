...
print("[12_02_model] 시작")

seed_file = "./Energy/12_submission/12_02_model.json"
...
test = pd.read_csv(save_path + 'test_csv/preprocessed_10_test.csv')
...
with open("./Energy/12_submission/12_02_model_log.txt", "a") as f:
    f.write(f"<SEED :{SEED}>\n")
    f.write(f"{filename}\n")
...
# <SEED :43>    6.6559843954
# 12_02_20250730_SMAPE_3_9408.csv
# SMAPE : 3.9407568288122787
# ========================================
