...
print("[12_02_model2] 시작")

seed_file = "./Energy/12_submission/12_02_model2.json"
...
filename = f"12_02_2_{today}_SMAPE_{score_str}_residual.csv"
samplesub.to_csv(save_path + filename, index=False)

with open("./Energy/12_submission/12_02_model2_log.txt", "a") as f:
    f.write(f"<SEED :{SEED}>\n")
    f.write(f"{filename}\n")
