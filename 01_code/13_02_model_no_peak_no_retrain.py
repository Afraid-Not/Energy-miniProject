...
train_call = '13_01_train_SEED65_rolling.csv'
test_call = '13_01_test_SEED65_rolling.csv'
...
#        'SIN_시', 'COS_시', '정오거리', '정오거리_INV', 'peak_time', '요일_0', '요일_1',
#        '요일_2', '요일_3', '요일_4', '요일_5', '요일_6', 'IDC(전화국)', '건물기타', '공공', '백화점',
#        '병원', '상용', '아파트', '연구소', '학교', '호텔', '불쾌지수', '태양광per냉방면적', 'ESS설치여부',
#        'PCS설치여부', '설비밀도', '기온_변화량_1h', '기온_변화량_2h', '기온_변화량_3h', '강수량_변화량_1h',
#        '강수량_변화량_2h', '강수량_변화량_3h', '풍속_변화량_1h', '풍속_변화량_2h', '풍속_변화량_3h'],
#       dtype='object')
# print(test.columns)
...
#        'peak_time', '요일_0', '요일_1', '요일_2', '요일_3', '요일_4', '요일_5', '요일_6',
#        'IDC(전화국)', '건물기타', '공공', '백화점', '병원', '상용', '아파트', '연구소', '학교', '호텔',
#        '불쾌지수', '태양광per냉방면적', 'ESS설치여부', 'PCS설치여부', '설비밀도', '기온_변화량_1h',
#        '기온_변화량_2h', '기온_변화량_3h', '강수량_변화량_1h', '강수량_변화량_2h', '강수량_변화량_3h',
#        '풍속_변화량_1h', '풍속_변화량_2h', '풍속_변화량_3h', '일조(hr)', '일사(MJ/m2)'],
#       dtype='object')
...
with open("./Energy/13_submission/(LOG)13_02_model.txt", "a") as f:
    f.write(f"<파일명 : 13_02_model_no_peak_no_retrain.py>\n") # Updated filename
    f.write(f"<SEED :{SEED}>\n")
    f.write(f"사용된 파일:\n")
