...
test_filename = f'13_01_test_SEED{SEED}_rolling.csv'
train_filename = f'13_01_train_SEED{SEED}_rolling.csv'
...
with open(save_path + "(LOG)13_01_preprocessing.txt", "a") as f:
    f.write(f"<파일명 : 13_01_preprocessing_rolling_features_no_peak_train_predict.py>\n")
    f.write(f"<SEED : {SEED}>\n")
